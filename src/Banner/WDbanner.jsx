...
function Vdbanner() {
  return (
    <div className="video-container hidden lg:block ">
      ...
      />
       <video 
        className="background-video block lg:hidden bc1"
      ...
      <div className="content">
         ...
         <h1 className="hidden md:block text-3xl md:text-5xl font-bold mb-4 pt-2 md:pt-0 text-red-100 ">
            Powering the Future
          </h1>
          <motion.div
                  ...
                  >
                    <div className="flex space-x-1 mb-1">
                      ...
                      <span className="w-1.5 h-1.5 bg-white rounded-full"></span>
                      <span className="w-1.5 h-1.5 bg-white rounded-full"></span>
                      <div className="w-14 h-[5px] bg-white rounded-full"></div>
                    </div>
                  </motion.div>
