...
export default function HomeNavbar() {
  ...
  const closeIndustries = () => {
    // small delay to allow cursor to move into dropdown without it closing
                  ...
                  <Link
                    ...
                    className={`text-lg font-semibold transition-all ${
                      scrolled
                        ...
                        : "text-white hover:text-[#d00000]"
                    }`}
                  >
                    {link.label}
                  </Link>

                  {/* Dropdown preview for industries - shows only on hover */}
                  {isIndustriesOpen && (
                    <div className="absolute top-full left-0 mt-0 w-52 bg-white rounded-lg shadow-lg overflow-hidden z-50">
                      <div className="p-2">
                        <Link
                          to="/sugarindustry"
                        ...
                        >
                          <div className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-md">
                            <GiSugarCane className="text-[#f50000] text-xl" />
                  ...
                  <div key={link.label}>
                    ...
                    <div className="pl-4 mt-2">
                      <Link
                        to="/sugarindustry"
                        onClick={() => setMenuOpen(false)}
                        className="flex items-center gap-2 text-sm text-gray-700 hover:text-[#d00000]"
                      >
                        <GiSugarCane /> Sugar
                      </Link>
                    </div>
